...
export const Search = <Option, OtpGroup = never, T extends ValidComponent = 'div'>(
  props: SearchProps<Option, OtpGroup, T>,
) => {
  return <SearchPrimitive data-slot="search" class="flex flex-col gap-2" {...props} />
}
...
export type SearchIndicatorProps<T extends ValidComponent = 'div'> = ComponentProps<
  typeof SearchPrimitive.Indicator<T>
>
...
export type SearchControlProps<T extends ValidComponent = 'div'> = ComponentProps<
  typeof SearchPrimitive.Control<T>
> & {
    ...
    >
      ...
      <SearchPrimitive.Input
        ...
        class={cx(
          ...
          (!props.rightIndicator?.() && !props.leftIndicator?.()) || props.rightIndicator?.()
            ? 'pr-3'
            : null,
        )}
      />
...
export type SearchContentProps<T extends ValidComponent = 'div'> = ComponentProps<
  typeof SearchPrimitive.Content<T>
>
...
export type SearchNoResultProps<T extends ValidComponent = 'span'> = ComponentProps<
  typeof SearchPrimitive.NoResult<T>
>
...
export type SearchLabelProps<T extends ValidComponent = 'label'> = ComponentProps<
  typeof SearchPrimitive.Label<T>
>
...
export type SearchDescriptionProps<T extends ValidComponent = 'div'> = ComponentProps<
  typeof SearchPrimitive.Description<T>
>
...
export type SearchItemDescriptionProps<T extends ValidComponent = 'div'> = ComponentProps<
  typeof SearchPrimitive.ItemDescription<T>
>
...
export type SearchItemLabelProps<T extends ValidComponent = 'div'> = ComponentProps<
  typeof SearchPrimitive.ItemLabel<T>
>
...
export const SearchListbox = <Option, OptGroup = never, T extends ValidComponent = 'ul'>(
...
export type SearchSectionProps<T extends ValidComponent = 'li'> = ComponentProps<
  typeof SearchPrimitive.Section<T>
>
