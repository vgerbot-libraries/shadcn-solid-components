...
export const FileField = <T extends ValidComponent = 'div'>(props: FileFieldProps<T>) => {
...
export type FileFieldDropzoneProps<T extends ValidComponent = 'div'> = ComponentProps<
  typeof FileFieldPrimitive.Dropzone<T>
>
...
export type FileFieldTriggerProps<T extends ValidComponent = 'button'> = ComponentProps<
  typeof FileFieldPrimitive.Trigger<T>
> &
...
export const FileFieldTrigger = <T extends ValidComponent = 'button'>(
  ...
  const [, rest] = splitProps(props as FileFieldTriggerProps, ['class', 'variant', 'size'])
...
export type FileFieldItemListProps<T extends ValidComponent = 'ul'> = ComponentProps<
  typeof FileFieldPrimitive.ItemList<T>
>
...
export type FileFieldItemProps<T extends ValidComponent = 'li'> = ComponentProps<
  typeof FileFieldPrimitive.Item<T>
>

export const FileFieldItem = <T extends ValidComponent = 'li'>(props: FileFieldItemProps<T>) => {
...
export type FileFieldItemPreviewImageProps<T extends ValidComponent = 'img'> = ComponentProps<
  typeof FileFieldPrimitive.ItemPreviewImage<T>
>

export const FileFieldItemPreviewImage = <T extends ValidComponent = 'img'>(
  props: FileFieldItemPreviewImageProps<T>,
) => {
  const [, rest] = splitProps(props as FileFieldItemPreviewImageProps, ['class'])
  const radiusClass = useRadiusClass('display')

  return (
    <FileFieldPrimitive.ItemPreviewImage
      data-slot="file-field-item-preview-image"
      class={cx('aspect-[1] h-auto w-14 self-center object-cover', radiusClass, props.class)}
      {...rest}
    />
  )
}

export type FileFieldItemSizeProps<T extends ValidComponent = 'span'> = ComponentProps<
  typeof FileFieldPrimitive.ItemSize<T>
>
...
export type FileFieldItemNameProps<T extends ValidComponent = 'span'> = ComponentProps<
  typeof FileFieldPrimitive.ItemName<T>
>
...
export type FileFieldItemDeleteTriggerProps<T extends ValidComponent = 'button'> = ComponentProps<
  typeof FileFieldPrimitive.ItemDeleteTrigger<T>
>

export const FileFieldItemDeleteTrigger = <T extends ValidComponent = 'button'>(
  props: FileFieldItemDeleteTriggerProps<T>,
) => {
  const [, rest] = splitProps(props as FileFieldItemDeleteTriggerProps, ['class', 'children'])
  ...
  return (
    ...
    >
      <Show when={!props.children} fallback={props.children}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="text-destructive">
          <path
            fill="none"
            stroke="currentColor"
...
export type FileFieldLabelProps<T extends ValidComponent = 'label'> = ComponentProps<
  typeof FileFieldPrimitive.Label<T>
>
...
export type FileFieldDescriptionProps<T extends ValidComponent = 'div'> = ComponentProps<
  typeof FileFieldPrimitive.Description<T>
>
...
export type FileFieldErrorMessageProps<T extends ValidComponent = 'div'> = ComponentProps<
  typeof FileFieldPrimitive.ErrorMessage<T>
>
