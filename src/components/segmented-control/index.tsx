...
export type SegmentedControlProps<T extends ValidComponent = 'div'> = ComponentProps<
  typeof SegmentedControlPrimitive<T>
>
...
export type SegmentedControlItemInputProps<T extends ValidComponent = 'input'> = ComponentProps<
  typeof SegmentedControlPrimitive.ItemInput<T>
>
...
export type SegmentedControlItemLabelProps<T extends ValidComponent = 'label'> = ComponentProps<
  typeof SegmentedControlPrimitive.ItemLabel<T>
>
...
export type SegmentedControlIndicatorProps<T extends ValidComponent = 'div'> = ComponentProps<
  typeof SegmentedControlPrimitive.Indicator<T>
>
...
export type SegmentedControlItemProps<T extends ValidComponent = 'div'> = ComponentProps<
  typeof SegmentedControlPrimitive.Item<T>
>
...
export type SegmentedControlLabelProps<T extends ValidComponent = 'span'> = ComponentProps<
  typeof SegmentedControlPrimitive.Label<T>
>
...
export type SegmentedControlDescriptionProps<T extends ValidComponent = 'div'> = ComponentProps<
  typeof SegmentedControlPrimitive.Description<T>
>
...
export type SegmentedControlItemDescriptionProps<T extends ValidComponent = 'div'> = ComponentProps<
  typeof SegmentedControlPrimitive.ItemDescription<T>
>

export const SegmentedControlItemDescription = <T extends ValidComponent = 'div'>(
...
export type SegmentedControlErrorMessageProps<T extends ValidComponent = 'div'> = ComponentProps<
  typeof SegmentedControlPrimitive.ErrorMessage<T>
>
