...
export const Resizable = <T extends ValidComponent>(props: ResizableProps<T>) => {
  ...
  return <ResizablePrimitive data-slot="resizable" class={cx('size-full', props.class)} {...rest} />
}
...
export type ResizableHandleProps<T extends ValidComponent = 'div'> = ComponentProps<
  typeof ResizablePrimitive.Handle<T>
> & {
  withHandle?: boolean
}
    ...
    >
      <Show when={props.withHandle}>
        <div class="bg-border z-10 flex h-4 w-3 items-center justify-center rounded-xs border">
          <svg xmlns="http://www.w3.org/2000/svg" class="size-2.5" viewBox="0 0 24 24">
            <g
              fill="none"
              stroke="currentColor"
