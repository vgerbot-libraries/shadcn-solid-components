...
export function ModeToggleDropdown(props: {
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger as={Button<"button">} variant="ghost" size="sm" {...props.trigger} class={cx('w-9 px-0', props.trigger?.class)}>
