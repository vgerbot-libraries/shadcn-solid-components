...
export const DrawerClose = <T extends ValidComponent = 'button'>(props: DrawerCloseProps<T>) => {
...
export const DrawerContent = <T extends ValidComponent = 'div'>(props: DrawerContentProps<T>) => {
...
export const DrawerHeader = (props: DrawerHeaderProps) => {
  ...
  return (
    <div data-slot="drawer-header" class={cx('flex flex-col gap-1.5 p-4', props.class)} {...rest} />
  )
}
